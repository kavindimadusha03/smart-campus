  ...
  return (
    <>
      ...
      <header className="sticky top-4 z-50 w-full px-4 md:px-6">
        <div className="mx-auto max-w-7xl rounded-2xl bg-sidebar-bg/80 backdrop-blur-md shadow-lg border border-white/10">
          ...
          {mobileOpen && (
            <div className="md:hidden mt-2 rounded-xl border border-white/10 bg-sidebar-bg/80 backdrop-blur-md px-3 pb-4 pt-2">
